#[cfg(feature = "std")]
use crate::lib::PathBuf;
use crate::lib::{format, Cell, String, ToString, Vec};

use crate::utils::is_big_endian;
use crate::{
    DataEncoding, DecodedData, FDSNSchema, FieldFlag, MS3Data, MS3Header, MS3Time, SampleRP,
    Steim1Decode, Steim1Encode, Steim2Decode, Steim2Encode, Steim3Decode, Steim3Encode,
};
...
impl MS3RecordBuilder {
    ...
    pub fn build_with_diff0(mut self, diff_0: i32) -> MS3Result<MS3Record> {
        ...
        self.header.castagoli = crate::CRC32C.checksum(&cs_bytes);
        Ok(MS3Record {
            header: self.header,
            data: self.data,
        })
